(() => {
              ...
              return function (a, o) {
                ...
                if (s && "setting" === a.type) {
                  ...
                  return (
                    ...
                    (l = o.select),
                    (f = null),
                    l === d.slides.length && (b(), L(d)),
                    t.each(d.anchors, function (t, i) {
                      e(t.els).each(function (t, r) {
                        e(r).index() === l && (f = i);
                      });
                    }),
                    null != f && M(d, { index: f, immediate: !0 }),
                    void 0
                  );
                }
                if ("swipe" === a.type)
                  return u.disableSwipe || r.env("editor")
                    ? void 0
                    : "left" === o.direction
                    ? E(i)()
                    : "right" === o.direction
                ...
                if (i.nav.has(a.target).length) {
                  ...
                  if (
                    ("click" === a.type && M(i, { index: c }),
                    "keydown" === a.type)
                  )
                    switch (a.keyCode) {
                      case n.ENTER:
                      case n.SPACE:
                        M(i, { index: c }), a.preventDefault();
                        break;
                      case n.ARROW_LEFT:
                      case n.ARROW_UP:
    ...
    (() => {
      ...
      i.O = function (t, r, a, n) {
        ...
        for (var s = 1 / 0, o = 0; o < e.length; o++) {
          for (
            var r = e[o][0], a = e[o][1], n = e[o][2], d = !0, l = 0;
            l < r.length;
            l++
          )
            (!1 & n || s >= n) &&
  ...
  var r = i.O(void 0, ["910", "699"], function () {
    return i("80212");
  });
  r = i.O(r);
})();
